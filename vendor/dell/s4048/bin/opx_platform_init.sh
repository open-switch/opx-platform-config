...
echo "System CPLD: $((`i2cget -y 2 0x31 0` & 0xf))" >> $FIRMWARE_VERSION_FILE
# Get Master CPLD version
echo "Master CPLD: $((`i2cget -y 2 0x32 1` & 0xf))" >> $FIRMWARE_VERSION_FILE
# Get Slave CPLD version
echo "Slave CPLD: $((`i2cget -y 2 0x33 0` & 0xf))" >> $FIRMWARE_VERSION_FILE
